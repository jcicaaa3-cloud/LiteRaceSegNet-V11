...
def main():
  ...
  mode_note = {
    ...
    "checkpoint": str(ckpt),
    "warning": None,
    "research_integrity": "Model mode does not replace bad masks unless --allow_demo_fallback is explicitly supplied.",
  }
  ...
  if use_model:
    ...
    if args.allow_demo_fallback:
      mode_note["warning"] = "Demo fallback was explicitly enabled. Do not use this output for research accuracy claims."
